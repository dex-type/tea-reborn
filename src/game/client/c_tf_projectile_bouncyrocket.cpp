...
#include "cbase.h"
#include "c_tf_projectile_bouncyrocket.h"
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_TFProjectile_BouncyRocket::OnDataChanged(DataUpdateType_t updateType)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_TFProjectile_BouncyRocket::CreateTrails(void)
{
	if (IsDormant())
		return;
